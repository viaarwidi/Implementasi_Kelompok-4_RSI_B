    ...
    if (result.isConfirmed) {
        try {
            ...
            if (response.ok) {
                ...
                // Refresh data dari server agar tetap konsisten
                fetchProgramDonasi();
            } else {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal',
                    text: error.message || 'Gagal menghapus program!',
                    confirmButtonText: 'OK'
                });
            }
        } catch (error) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Kesalahan',
                text: 'Terjadi kesalahan saat menghapus program. Silakan coba lagi.',
                confirmButtonText: 'OK'
            });
        }
    }
